					...
					<div className="text-left h-full max-w-[600px] mx-auto">
						...
						<div className="flex justify-left pb-5">
							<Text className="text-sm font-medium max-w-[600px] text-left">
								...
								committed to delivering the best possible experience to their customers but lack the knowledge or
								capacity to scale to $500K per month and beyond.
							</Text>
						</div>
						<Divider className="mt-5" align="left">
							What We Do
						...
						<div className="flex justify-left pb-5">
							<Text className="text-sm font-medium max-w-[600px] text-left">
								...
								<br />
								<br />
								<strong>3. We help you focus on what moves the needle: </strong> So you're not wasting time on things
								that don’t drive real results.
								<br />
								<br />
						...
						<div className="flex justify-left pb-5">
							<Text className="text-sm font-medium max-w-[600px] text-left">
								...
								spending $100K–$200K per month on ads, then improving performance by 10% and reducing waste by 15% at
								the same spend results in a ~30% increase in revenue and 140% increase in profit. Yes, 140% -
								optimisation is as important as scale.
								<br />
								<br />
								...
								<br />
								<br />
								We let data be the guide. Once your business is systemized, we can measure inputs and outputs compared
								to our North Star.
								<br />
								<br />
						...
						<div className="flex justify-left">
							<Text className="text-sm font-medium max-w-[600px] text-left">
								...
								<br />
								<br />
								<strong>Be Customer Obsessed:</strong> Start with the customer and work backwards - our customers are
								not our partners - their customers are.
								<br />
								<br />
