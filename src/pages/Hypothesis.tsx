				...
				<div className="text-left h-full">
					...
					<div className="flex justify-center">
						<Text className="text-sm font-medium max-w-[600px] text-left">
							...
							claim (transformation) to that niche, which is willing to pay a price to have the promise fulfilled or the
							transformation realised. A speicifc mechanism is used to deliver that transformation. The access channel,
							or districution channel, consists of the traffic and conversions vehicles that bring the mechanism to the
							niche.
							<br />
							<br />
							...
							<br />
							<br />
							An NTPMA solution validates contribution after marketing value, meaning the cost of marketing and selling
							the mechanism through an access channel is lower than the earnings generated from that mechanism.
							<br />
							<br />
